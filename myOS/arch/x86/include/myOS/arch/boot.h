...
namespace myOS::arch::boot {
     ...
     */
    inline uintptr_t getKernelStart() { return reinterpret_cast<uintptr_t>(__kernel_start); }

    /**
     * @brief Get kernel end address
     */
    inline uintptr_t getKernelEnd() { return reinterpret_cast<uintptr_t>(__kernel_end); }

    /**
     * @brief Get kernel size in bytes
     */
    inline size_t getKernelSize() { return getKernelEnd() - getKernelStart(); }

    /**
     * @brief Get text section size
     */
    inline size_t getTextSize() { return reinterpret_cast<uintptr_t>(__text_end) - reinterpret_cast<uintptr_t>(__text_start); }

    /**
     * @brief Get data section size
     */
    inline size_t getDataSize() { return reinterpret_cast<uintptr_t>(__data_end) - reinterpret_cast<uintptr_t>(__data_start); }

    /**
     * @brief Get BSS section size
     */
    inline size_t getBssSize() { return reinterpret_cast<uintptr_t>(__bss_end) - reinterpret_cast<uintptr_t>(__bss_start); }
